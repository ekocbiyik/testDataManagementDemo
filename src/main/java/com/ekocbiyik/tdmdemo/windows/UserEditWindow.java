...
/**
 * Created by enbiya on 02.03.2017.
 */
public class UserEditWindow extends Window {
    ...
    public UserEditWindow(User user, Table userTable) {
        ...
        setCaption("Kullanıcı Güncelleme Ekranı");
    ...
    private Component buildContent() {
        ...
        cbxRole.removeItem(EUserRole.SYSADMIN);
...
//        txtPassword.setValue(user.getPassword());/** böyle birşey olmaz!!*/
        ...
        cbxActivePasive.setValue(user.getActive());
